          ...
          <>
            ...
            <div style={{ position: 'relative', marginBottom: 22 }}>
              <input type={showPassword ? 'text' : 'password'} value={password} onChange={e => setPassword(e.target.value)} onKeyDown={e => e.key === 'Enter' && handleLogin()}
                ...
                style={{ width: '100%', background: 'var(--panel2)', border: '1px solid var(--border)', borderRadius: 8, padding: '11px 44px 11px 14px', color: 'var(--text)', fontSize: '.9rem', fontFamily: 'var(--font)', outline: 'none' }} />
